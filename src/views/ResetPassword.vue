    ...
    <div class="login-card">
      ...
      <form class="grid mt" style="gap:12px" @submit.prevent="save">
        <div class="field"><label>รหัสผ่านใหม่ (อย่างน้อย 8 ตัวอักษร)</label>
          <input v-model="pw" type="password" minlength="8" class="input" autocomplete="new-password" required /></div>

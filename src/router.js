...
const routes = [
  ...
  { path: '/reset-password', component: v('ResetPassword'), meta: { public: true, title: 'ตั้งรหัสผ่านใหม่' } },
  {
    path: '/', component: AppLayout, children: [
      ...
      { path: 'training/sessions', component: v('training/Sessions'), meta: { title: 'Training Session' } },
      { path: 'training/sessions/new', component: v('training/SessionForm'), meta: { title: 'สร้าง Training', edit: true } },
